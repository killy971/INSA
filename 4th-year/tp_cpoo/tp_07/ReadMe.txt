========================================================================
    APPLICATION CONSOLE : vue d'ensemble du projet tp_07
========================================================================

AppWizard a créé cette application tp_07 pour vous.  
Ce fichier contient un résumé du contenu de chacun des fichiers qui
constituent votre application tp_07.
...
StdAfx.h, StdAfx.cpp
    ...
    nommé tp_07.pch et un fichier de type précompilé nommé StdAfx.obj.
