public class Test {
	...
	public static void main(String args[]) {
		...
		TableCouples t = new TableCouples();
	    ...
	    t.ajouter( new Mot("Écran pixel"), new Mot("bit map screen") );
		...
		*/
		...
		System.out.println(t.traduire(new Mot("Accès séquentiel")));
		System.out.println(t.traduire(new Mot("Afficher")));
		System.out.println(t.traduire(new Mot("jiulay")));
